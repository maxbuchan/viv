                    Bitnami MediaWiki Stack 1.29.1-1
                  ==============================
...
bitnami-mediawiki-1.29.1-1-linux-installer.run on Linux or
bitnami-mediawiki-1.29.1-1-linux-x64-installer.run on Linux 64 bit or
bitnami-mediawiki-1.29.1-1-windows-installer.exe on Windows or
bitnami-mediawiki-1.29.1-1-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-mediawiki-1.29.1-1-linux.run
...
Stack in /home/user/mediawiki-1.29.1-1 on Linux or C:\Program Files\Bitnami MediaWiki Stack
on Windows or /Applications/mediawiki-1.29.1-1 and that you use port 
...
"Cannot open bitnami-mediawiki-1.29.1-1-linux.run: No application suitable for
...
/home/user/mediawiki-1.29.1-1/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami MediaWiki Stack\apache2\logs\error.log on Windows or
/Applications/mediawiki-1.29.1-1/apache2/logs/error.log on OS X.
